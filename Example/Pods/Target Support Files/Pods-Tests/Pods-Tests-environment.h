...
// CPAutoLayout
#define COCOAPODS_POD_AVAILABLE_CPAutoLayout
#define COCOAPODS_VERSION_MAJOR_CPAutoLayout 0
#define COCOAPODS_VERSION_MINOR_CPAutoLayout 8
#define COCOAPODS_VERSION_PATCH_CPAutoLayout 0
